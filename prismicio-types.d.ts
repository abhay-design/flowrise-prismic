...
interface TestimonialDocumentData {
  ...
  /**
   * Avtar field in *Testimonial*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonial.avtar
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface TestimonialsSliceDefaultPrimaryGroupItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → Group*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.group[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
